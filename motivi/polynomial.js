...
(function(root) {
   ...
   * @param {String|Object|number} L The init polynomial
   ...
   * @param {Object} L The numerator coefficients
   ...
   * @param {String|Object|null|number} L The polynomial to be parsed
  ...
  var parse = function(L) {
    ...
    switch (typeof L) {
      ...
      case "object":
        ...
        if (Fraction && L instanceof Fraction || Complex && L instanceof Complex || Quaternion && L instanceof Quaternion) {
      ...
      case "string":
        ...
        while (null !== (tmp = STR_REGEXP['exec'](L))) {
   ...
   * @param {String|Object} L The denominator polynomial

   * @returns {Polynomial}

   */

  Polynomial.prototype['gcd'] = function(L) {
   ...
   * Numerically evaluate the polynomial at a specific point L by
   ...
   * @param {number} L The point where to evaluate this polynomial

   * @returns {number} The value P(L)

   */

  Polynomial.prototype['eval'] = function(L) {
   ...
   * @param {String|Object} L The summand polynomial

   * @returns {Polynomial}

   */

  Polynomial.prototype['add'] = function(L) {
   ...
   * @param {String|Object} L The subtrahend polynomial

   * @returns {Polynomial}

   */

  Polynomial.prototype['sub'] = function(L) {
   ...
   * @param {String|Object} L The minuend polynomial

   * @returns {Polynomial}

   */

  Polynomial.prototype['mul'] = function(L) {
   ...
   * @param {String|Object} L The first factor polynomial
  ...
  Polynomial.prototype['div'] = function(L) {


    return new Polynomial(div(clone(this['coeff']), parse(L)));
   ...
   * @param {String|Object} L The second poly

   * @returns {Polynomial}

   */

  Polynomial.prototype['mod'] = function(L) {
